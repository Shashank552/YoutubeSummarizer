...
# Getting the transcript text from yt videos
...
#Getting the summary text based on prompt from Google Gemini Pro 
...
st.title("Youtube Transcript to Detailed Notes Coverter")
